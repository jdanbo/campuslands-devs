...
Un laboratorio educativo registra mezclas simples y necesita validar cantidades.
...
Calcular masa total y detectar fórmulas incompletas.

## Explicación paso a paso

1. Crea compuestos con nombre y componentes.
2. Cada componente debe tener simbolo y gramos.
3. Suma gramos por compuesto.
4. Valida que ningun componente tenga gramos <= 0.
5. Filtra compuestos incompletos.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu carpeta personal dentro de esta ruta: `basico/logica/ejercicio-14/resoluciones/nombre-apellido/`.
...
H2O puede representarse con H y O, cada uno con gramos mayores a 0.
